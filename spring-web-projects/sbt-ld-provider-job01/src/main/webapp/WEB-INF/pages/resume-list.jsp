		...
		<div class="col-md-12 column">
			...
			<div>
				<table id="tableId" class="easyui-datagrid"
								data-options="url:'/resume/findAll',
								pagination:true,
								fitColumns:true,
								singleSelect:false,
								method:'get',
					...
					<thead>   
				        <tr>   
				            ...
				            <th data-options="field:'locationId'">locationId</th>
				            <th data-options="field:'phone'">phone</th>
				            <th data-options="field:'edu'">edu</th>
				            <th data-options="field:'profession'">profession</th>
				            <th data-options="field:'curSalary'">curSalary</th>
				            <th data-options="field:'lowSalaryExp'">lowSalaryExp</th>
				            <th data-options="field:'topSalaryExp'">topSalaryExp</th>
				            
				            <th data-options="field:'updated'">updated</th>
				            <th data-options="field:'created'">created</th>
...
<script type="text/javascript">
	var toolBats = [ {
		...
		handler : function() {
			...
			$.post("/resume/delete",{ids:ids},function(data){
				if(data.status==200){
					$("#tableId").datagrid("reload");
					alert("删除成功!");
				}else{
