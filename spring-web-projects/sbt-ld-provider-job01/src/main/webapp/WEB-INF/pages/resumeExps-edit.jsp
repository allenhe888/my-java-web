...
<div style="padding:10px 10px 10px 10px">
	<form id="editFormId" class="itemForm" method="post">
	    <table cellpadding="5">
	        ...
	        <tr>
	            <td>company:</td>
	            <td><input type="text" name="company"  class="easyui-textbox" data-options="required:true" style="width: 280px;"></input></td>
	        </tr>
	        <tr>
	            <td>role:</td>
	            <td><input type="text" name="role"  class="easyui-textbox" data-options="" style="width: 280px;"></input></td>
	        </tr>
	        
	        <tr>
	            <td>jobDuty:</td>
	            <td><input type="text" name="jobDuty"  class="easyui-textbox" data-options="" style="width: 280px;"></input></td>
	        </tr>
...
<script type="text/javascript">
	...
	function submitForm(){
		setUpdateSaveFunction("/resumeExps/update","/resumeExps/save");
	}
