				...
				<table id="tableId" class="easyui-datagrid"
					...
					<thead>   
				        <tr>   
				            ...
				            <th data-options="field:'school'">school</th>
				            <th data-options="field:'degree'">degree</th>
				            <th data-options="field:'achieved'">achieve</th>
				        </tr>   
				    </thead>   
				    <tbody>   
				    </tbody>   
...
<script type="text/javascript">
	var toolBats = [ {
		...
		handler : function() {
			...
			$.post("/edu/delete",{ids:ids},function(data){
				if(data.status==200){
					$("#tableId").datagrid("reload");
					alert("删除成功!");
				}else{
