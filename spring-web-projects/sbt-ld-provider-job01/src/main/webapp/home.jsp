		...
		<div class="col-md-12 column">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li class="active"><a href="#" onclick="addTab('Resume','resume/list')">myResume</a></li>
					<li><a href="#" onclick="addTab('User','user/list')">User Center</a></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">Recruit Center<strong class="caret"></strong></a>
						<ul class="dropdown-menu">
							<li><a href="#" onclick="addTab('PostJob','job/post')">Post New Job</a></li>
							<li><a href="#" onclick="addTab('Job','job/list')">Job List</a></li>
							<li class="divider"></li>
